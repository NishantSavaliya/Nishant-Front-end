            ...
            return(
                  <>
                        <tr>
                              ...
                              <td>
                                    <button type='button' onClick={()=>navigate(`/admin-login/delete-food-category/${item.id}`)} className='btn btn-sm btn-danger text-white bg-danger'>
                                          <span className='bi bi-trash'></span>
                                    </button>
                                    
                                    <button type='button' onClick={()=>navigate(`/admin-login/update-food-category/${item.id}`)} className='btn btn-sm text-white bg-primary ms-2'>
